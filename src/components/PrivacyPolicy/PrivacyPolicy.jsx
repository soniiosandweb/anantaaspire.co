    ...
    return (
        <>
            ...
            <section className="max-w-5xl m-auto py-14 px-2.5 text-left flex flex-col gap-3">
                <h3 className="text-3xl uppercase font-semibold text-primary-darkblue pt-1 text-center">Privacy Policy</h3>
                ...
                <h5 className="text-xl text-primary-darkblue font-semibold">Update of Privacy Policy</h5>
                ...
                <h5 className="text-xl text-primary-darkblue font-semibold">User Information</h5>
                ...
                <h5 className="text-xl text-primary-darkblue font-semibold">Security</h5>
